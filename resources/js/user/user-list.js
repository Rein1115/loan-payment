$(document).ready(function () {
                    ...
                    $("table.datatable tbody").append(`
                        <tr>
                            ...
                            <td>${item.username}</td>
                             ...
                             <td><button class="btn btn-primary btnDetails" data-id="${
                            item.id
    ...
    $("#btnShowNewModal").on("click", () => {
        ...
        $('.btnOption').attr('id', 'save');
        $('.btnOption').removeClass();
        $('#save').addClass('btn btn-primary btnOption');
        $('#save').text('Save');
        ...
        axios
            ...
            .then((response) => {
                ...
                $("#save")
                    ...
                    .addClass("btn btn-success Update")
                    .text("Update");
                $("#adduser").modal("show");
