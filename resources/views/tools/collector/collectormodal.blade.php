...
<div class="modal fade" id="modalsaveupdate" tabindex="-1" data-bs-backdrop="false">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    <input id="fname" type="number" class="form-control" name="fname" value="{{ old('fname') }}" required autocomplete="fname" autofocus>
                </div>
            </div>
            <div class="row mb-3">
